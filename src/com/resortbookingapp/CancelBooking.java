...
public class CancelBooking extends JFrame {
	...
	public CancelBooking() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				int roomNumber = Integer.parseInt(txtRoomNo.getText());
		            ...
		            try {
		                ...
		                String insertQuery = "DELETE FROM tblbookings WHERE room_No = " + roomNumber;
		                ...
		                if (rowsAffected > 0) {
		                    ...
		                    JOptionPane.showMessageDialog(CancelBooking.this,"Booking Cancelled successfully for room " + roomNumber, "Booking Canceled", JOptionPane.INFORMATION_MESSAGE);
		                } else {
		                	JOptionPane.showMessageDialog(CancelBooking.this,"No Booking found for room " + roomNumber, "Input Error", JOptionPane.ERROR_MESSAGE);
		                }
		...
		txtCancelBooking.setBounds(762, 620, 125, 31);
